...
var nodeInit = function (RED) {
        ...
        if (this.server) {
            this.on("input", function (msg, send, done) {
                return __awaiter(this, void 0, void 0, function () {
                    var override, brightness, err_1;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 2, , 3]);
                                override = RED.util.evaluateNodeProperty(this.override, this.overrideType, this, msg);
                                ...
                                return [4 /*yield*/, this.server.light.setBrightness(msg.brightness)];
                            case 1:
                                _a.sent();
    ...
    RED.nodes.registerType("set-brightness", setNodeConstructor);
};
